...
import { useStudents } from './_layout';
...
export default function EnrolScreen() {
  ...
  const [form, setForm] = useState<FormState>({ name: '', email: '', rollNo: '', course: '' });
    ...
    <ScrollView style={styles.scroll} contentContainerStyle={styles.container} keyboardShouldPersistTaps="handled">
      ...
      <View style={styles.card}>
        ...
        <View style={styles.field}>
          ...
          <TextInput
            style={[styles.input, errors.rollNo ? styles.inputError : null]}
            value={form.rollNo}
        ...
        <View style={styles.field}>
          ...
          <View style={styles.pickerWrap}>
            <Picker
              ...
              onValueChange={(v: string) => update('course', v)}
              style={styles.picker}
        ...
        <View style={styles.actions}>
          <TouchableOpacity
            style={[styles.submitBtn, submitted ? styles.submitBtnSuccess : null]}
...
const styles = StyleSheet.create({
  ...
  label: { fontSize: 11, letterSpacing: 1.5, fontWeight: '700', color: '#4a3f35', textTransform: 'uppercase', marginBottom: 6 },
  ...
  submitBtn: { flex: 1, backgroundColor: '#c0392b', paddingVertical: 13, borderRadius: 3, alignItems: 'center' },
  submitBtnSuccess: { backgroundColor: '#2a5c3f' },
  submitBtnText: { color: '#fff', fontWeight: '700', fontSize: 14, letterSpacing: 0.5 },

  clearBtn: { paddingVertical: 13, paddingHorizontal: 20, borderRadius: 3, borderWidth: 1, borderColor: '#c8b89a', alignItems: 'center' },
